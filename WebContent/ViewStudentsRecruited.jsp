              ...
              <td width="737" height="42"><div align="center" class="style25">
                <form name="form1" method="post" action="">
                  <label>
                    ...
                    <select name="notiid" id="id" onChange="javascript:location.href='ViewStudentsRecruited.jsp?notiid='+document.form1.notiid.value">                        
                        <%
             ...
             if(!cCoreHash.isEmpty())
          	{
          	    report += "<table width='60%' border='0' align='center'><tr>"+
                    ...
                    "</tr>";
          	%>
                    <span class="style36"> <center>Placed Students</center> <div align="Right">    <strong> Export to:</strong> <a href="ExportXLS"><strong>XLS</strong> </a></div></span>
